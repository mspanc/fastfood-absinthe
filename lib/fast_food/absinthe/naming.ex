defmodule FastFood.Absinthe.Naming do
  ...
  @ecto_schema_prefix_length Application.compile_env!(:fastfood_absinthe, :ecto_schema_prefix)
                             |> to_string()
                             |> String.split(".")
                             |> length()
  ...
  def ecto_field_type_to_absinthe_type(ecto_type) do
    ...
    case ecto_type do
      ...
      {:parameterized, Ecto.Embedded,
       %Ecto.Embedded{cardinality: :one, related: related_ecto_schema}} ->
  ...
  defp do_ecto_schema_to_absinthe_type(
         ecto_schema,
         override_fun,
         prefix \\ nil,
         suffix \\ nil,
         pluralize_base \\ false
       ) do
  ...
  defp do_ecto_schema_to_graphql_type(
         ecto_schema,
         override_fun,
         prefix \\ nil,
         suffix \\ nil,
